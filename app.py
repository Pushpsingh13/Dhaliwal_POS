...
def get_secret(key: str, default: str = "") -> str:
    """Return secret from st.secrets or env, else default."""
    try:
...
with col2:
    ...
    if st.session_state.bill:
        ...
        # Build receipt to download/send
        ...
        if st.button("Finalize Order (Log + Selected Sends)"):
            ...
            # Email
            if send_email and pdf_buffer and st.session_state.cust_email:
...
# NOTE
# =========================
# We intentionally do NOT auto-open a browser tab to avoid 'refused to connect'.
# Launch with: streamlit run pos_app.py
# Then open the exact URL printed in your terminal (usually http://localhost:8501).
